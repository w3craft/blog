          ...
          r(t, null, [
            {
              ...
              value: function (e) {
                var t = void 0;
                (t =
                  "object" === o(e.classList) && e.classList.contains("navbar")
                    ? [e]
                    : e.querySelectorAll(".navbar")),
                  i.default.each(t, function (e) {
                    (0, i.default)(e).navbar({
                      sticky: !!e.hasAttribute("data-sticky"),
                      stickyOffset: e.hasAttribute("data-sticky-offset")
                        ? e.getAttribute("data-sticky-offset")
                        : 0,
                      hideOnScroll: !!e.hasAttribute("data-hide-on-scroll"),
                      tolerance: e.hasAttribute("data-tolerance")
                        ? e.getAttribute("data-tolerance")
                        : 0,
                      hideOffset: e.hasAttribute("data-hide-offset")
                        ? e.getAttribute("data-hide-offset")
                        : null,
          ...
          r(t, [
            {
              ...
              value: function () {
                ...
                this.triggerElement &&
                  ...
                  i.default.each(this.dropdowns, function (t) {
          ...
          i(t, [
            {
              ...
              value: function () {
                if (this.config.get("showHeader")) {
                  ...
                  var e =
                    "warning" == this.config.get("type") ? "black" : "white";
                  (this.headerTitle = s.default.createElement("p", [
                    "modal-card-title",
                    "has-text-" + e,
                  ])),
                    (this.headerTitle.innerHTML = this.title),
                ...
                (this.cardBody = s.default.findOrCreateElement(
                  ...
                  this.cardBody.innerHTML ||
                    (this.cardBody.innerHTML = this.body),
                  (this.footer = s.default.findOrCreateElement(
                    ".modal-card-foot",
                    this.content,
                    "footer"
                  ));
            ...
            },
            {
              ...
              value: function () {
                ...
                "string" == typeof n && (n = { label: n, classes: [] }),
                  (n = r({}, t, n));
                var o = s.default.createElement(
                  "button",
                  ["button", "is-" + this.config.get("type")].concat(n.classes)
                );
                if (
                  ((o.innerHTML = n.label),
                  ...
                  "string" == typeof i && (i = { label: i, classes: [] }),
                    (i = r({}, t, i));
          ...
          r(t, null, [
            {
              ...
              value: function (e) {
                var t = void 0;
                (t =
                  "object" === o(e.classList) && e.classList.contains("file")
                    ? [e]
              ...
              value: function () {
                ...
                this.filename &&
                  ...
                  this.root.addEventListener("drop", function (t) {
                    t.preventDefault(),
                      e.removeHoverClass(),
                      (e.input.files = t.dataTransfer.files);
                  });
              },
            },
            {
              ...
              value: function (e) {
                0 === e.target.files.length && this.clearFileName(),
                  ...
                  e.target.files.length > 1 &&
                    this.setFileName(e.target.files.length + " files"),
          ...
          r(t, null, [
            {
              ...
              value: function (e) {
                var t = void 0;
                (t =
                  "object" === o(e.classList) && e.classList.has("tabs-wrapper")
                    ? [e]
          ...
          r(t, null, [
            {
              ...
              value: function (e) {
                var t = void 0;
                (t =
                  "object" === o(e.classList) && e.classList.contains("panel")
                    ? [e]
