      ...
      var l = (t.File = (function (e) {
        function t(e, n) {
          ...
          return (
            ...
            (r.input = r.root.querySelector("input")),
            (r.filename = r.root.querySelector(".file-name")),
            r.registerEvents(),
            (0, i.default)(r.root).data("file", r),
            r.trigger("init"),
            r
          );
        }
          ...
          o(t, null, [
            {
              ...
              value: function (e) {
                var t = void 0;
                (t =
                  "object" === r(e.classList) && e.classList.contains("file")
                    ? [e]
