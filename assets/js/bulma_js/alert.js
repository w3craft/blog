!(function (e, t) {
  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      r.default.registerPlugin("modal", l), (t.default = r.default);
    },
    ,
    ,
    ,
    ...
    function (e, t, n) {
      ...
      var s = (t.Alert = (function (e) {
        function t(e, n) {
          ...
          return (
            ...
            (0, l.default)(o.root).data("alert", o),
            o.trigger("init"),
            o.open(),
            o
          );
          ...
          i(t, [
            {
              ...
              value: function () {
                if (this.config.get("showHeader")) {
                  this.header = l.default.findOrCreateElement(
                    ".modal-card-head",
                    this.content,
                    "header",
                    [
                  ...
                  (this.headerTitle = l.default.createElement("p", [
                    "modal-card-title",
                    "has-text-" + e,
                  ])),
                    (this.headerTitle.innerHTML = this.title),
                ...
                (this.cardBody = l.default.findOrCreateElement(
                  ".modal-card-body",
                  this.content,
                  "section"
                )),
                  this.cardBody.innerHTML ||
                    (this.cardBody.innerHTML = this.body),
                  (this.footer = l.default.findOrCreateElement(
                    ".modal-card-foot",
                    this.content,
                    "footer"
                  ));
      ...
      l.default.registerPlugin("alert", s), (t.default = l.default);
    },
  ]).default;
});
